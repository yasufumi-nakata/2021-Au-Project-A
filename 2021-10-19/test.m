...
try
    ...
    for i=1:length(list)
        ...
        % Background draw
        if list(i)==1
            Screen('FillOval', window, [255 255 255], vis_left);
            Screen('FillOval', window, [255 255 255], somato_left);
        ...
        Screen('DrawLines', window, fix, [2 2 2], [255, 255, 255]);
        Screen('FillOval', window, [0 0 0], somato_left);
        Screen('FillOval', window, [0 0 0], somato_right);
